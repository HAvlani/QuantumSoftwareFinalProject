...
namespace QAOA
{
    ...
    public partial class Main : Operation<QVoid, QVoid>, ICallable
    {
        ...
        protected ICallable<QVoid, QVoid> MakeCircuit__
        {
            get;
            set;
        }
...
#line 11 "/Users/harshilavlani/QuantumSoftwareFinalProject/QAOA/Program.qs"
            MakeCircuit__.Apply(QVoid.Instance);
#line hidden
        ...
        {
            this.MakeCircuit__ = this.__Factory__.Get<ICallable<QVoid, QVoid>>(typeof(MakeCircuit));
        }
...
#line hidden
    ...
    public partial class MakeCircuit : Operation<QVoid, QVoid>, ICallable
    {
...
#line 41 "/Users/harshilavlani/QuantumSoftwareFinalProject/QAOA/Program.qs"
                    MixingUnitary__.Apply((register, beta));
#line 42 "/Users/harshilavlani/QuantumSoftwareFinalProject/QAOA/Program.qs"
...
#line hidden
        ...
        public static System.Threading.Tasks.Task<QVoid> Run(IOperationFactory __m__)
        {
            return __m__.Run<MakeCircuit, QVoid, QVoid>(QVoid.Instance);
        }
    }
}